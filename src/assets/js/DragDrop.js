export default {
    ...
    methods: {
        ...
        mouseUp(e) {
            ...
            if (this.$el.contains(elem.closest(".task"))) {
        ...
        _writePosition(elem) {
            ...
            for (let key in this.optionsTodo.task) {

                this.optionsTodo.task[key].textTask = first.innerText;
                this.optionsTodo.task[key].checked = first.querySelector("input[type=checkbox]").checked;
                this.optionsTodo.task[key].id = first.getAttribute("data-id");
